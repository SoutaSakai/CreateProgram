...
const float CharacterManager::PorcupinefishSpeed = 7;	
...
const float CharacterManager::LionfishSpeed = 7;			
...
const float CharacterManager::MirrormorayellSpeed = 7;		
...
const float CharacterManager::TurtleSpeed = 7;				
