...
//‰¼
static const int MaxPlyer = 2;

CHARACTER_ID UseCharacter[MaxPlyer][3] =
{ {CHARACTER_ID::MIRRORMORAYELL,CHARACTER_ID::DUMMY,CHARACTER_ID::DUMMY},
	{CHARACTER_ID::LIONFISH,CHARACTER_ID::DUMMY,CHARACTER_ID::DUMMY}/*,
